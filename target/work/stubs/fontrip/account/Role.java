...
@groovy.transform.EqualsAndHashCode(includes="authority") @groovy.transform.ToString(includeNames=true, includes="authority", includePackage=false) public class Role
...
public  java.lang.String getAuthority() { return (java.lang.String)null;}
